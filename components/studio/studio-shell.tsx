...
export function StudioShell({ displayName, children }: Props) {
  return (
    <div className="flex min-h-dvh bg-[#040d06] text-[#f8f8f8]">
      <StudioNav displayName={displayName} />
      <div className="flex min-h-dvh min-w-0 flex-1 flex-col pb-16 md:pb-0">
        <main className="relative flex-1 overflow-x-hidden">
          <div
            aria-hidden
            className="pointer-events-none absolute -left-24 top-0 h-72 w-72 rounded-full bg-[#1DB954]/10 blur-[100px]"
          />
