...
export const spotifyDirectProvider: DistributionProvider = {
  id: "spotify-direct",
  configured: false,
  ...
  async submitRelease() {
    return notConfigured(
      "Spotify direct delivery is not available in Phase 1. Use the demo or LabelGrid partner rail.",
    );
  },

  async getStatus() {
    return notConfigured(
      "Spotify direct status checks are not available in Phase 1.",
    );
  },
};
