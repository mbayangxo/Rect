  ...
  return (
    <>
      ...
      <p className="mt-2 text-sm text-white/45">
        Audio is measured on upload (LUFS, true peak, silence). Failures save as
        draft and block go-live until fixed. RECT Punch mastering comes later —
        Taali still gets your master file from Delivery.
      </p>
