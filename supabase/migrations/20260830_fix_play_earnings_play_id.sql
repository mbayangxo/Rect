...
alter table public.artist_play_earnings
  drop constraint if exists artist_play_earnings_play_unique;

alter table public.artist_play_earnings
  drop column if exists play_id;

alter table public.artist_play_earnings
  add column play_id uuid not null;

alter table public.artist_play_earnings
  add constraint artist_play_earnings_play_unique unique (play_id);
