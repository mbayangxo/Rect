...
export function HomeCollage() {
  ...
  return (
    <div className="relative mx-auto h-[34rem] w-full max-w-xl sm:h-[40rem] lg:h-[44rem] lg:max-w-none">
      ...
      <figure className="absolute top-[6%] right-[10%] w-[42%] min-w-[9.5rem] rotate-[8deg] border-[10px] border-white bg-ink shadow-2xl">
        <div className="flex aspect-[4/5] items-end bg-pink p-3 font-display text-3xl leading-none tracking-[0.08em] text-ink sm:text-5xl">
          NEWS
        </div>
      </figure>
      <figure className="absolute bottom-[6%] left-[6%] w-[38%] min-w-[9rem] -rotate-[7deg] border-[10px] border-lime bg-ink p-4 shadow-2xl">
        <p className="font-display text-2xl leading-none tracking-[0.1em] text-lime sm:text-4xl">
          {site.name}
        </p>
      </figure>
      <Link
